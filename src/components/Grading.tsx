...
const projects = [
  { id: 1, title: "COLOUR GRADING", likes: "188", image: "/assets/grading-1.png" },
  { id: 2, title: "CINEMATIC LOOK", likes: "245", image: "/assets/grading-2.png" },
  { id: 3, title: "VINTAGE FILM", likes: "512", image: "/assets/grading-3.png" },
  { id: 4, title: "URBAN MOOD", likes: "120", image: "/assets/grading-4.png" },
];
...
export default function Grading() {
  ...
  return (
    ...
    <section ref={containerRef} className="grading-section" style={{
      background: 'radial-gradient(circle at 50% 50%, #051122 0%, #000000 100%)',
      position: 'relative',
      zIndex: 10,
      height: '100vh',
      overflow: 'hidden'
      ...
      <div style={{
        ...
        background: `
          ...
          radial-gradient(circle at 80% 20%, rgba(0, 102, 255, 0.15), transparent 50%)
        `,
        pointerEvents: 'none',
        zIndex: -1
      }} />
